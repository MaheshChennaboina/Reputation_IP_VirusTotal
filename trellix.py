        ...
        try:            
            ...
            if response['response_code'] != 0 :
                ...
                if final_scan_summary != 0:
                    ...
                    sha1_hash   = response['sha1']
                    sha256_hash = response['sha256']    
                self.printer(f"{Fore.YELLOW}Scan Result: {Fore.RED}{status}{Fore.YELLOW} [IOC: {Fore.GREEN}{ioc_hash}{Fore.YELLOW}]{Fore.YELLOW}[Malicious Count:{Fore.RED}{malicous_vendors_count}]{Style.RESET_ALL}", "INFO")
            else:
                status = "Not Found"
            ...
            return status, md5_hash, sha1_hash, sha256_hash, malicous_vendors_count
